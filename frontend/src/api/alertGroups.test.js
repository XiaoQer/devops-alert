...
import { fetchAlertGroupMembers, fetchAlertGroups, fetchAlertGroupSummary, fetchIncidentAlertGroups } from "./alertGroups";
...
describe("告警组 API", () => {
  it("列表传递筛选和独立分页", async () => {
    ...
    await fetchAlertGroups({ state: "ACTIVE", storm_state: "STORM", query: "支付", limit: 50, offset: 50 });
