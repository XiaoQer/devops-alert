...
### 任务 4：保存实体摘要并转交问题签名归组

- [x] AlertGroup 支持可空 service 并保存真实实体摘要；
- [x] 修复无 service 告警归组任务的模型与持久化失败；
- [ ] 不再把资源实例实体键作为最终问题边界；
- [ ] 后续按 `docs/superpowers/plans/2026-08-26-problem-signature-alert-grouping.md` 实施问题签名归组和事故跳过。
